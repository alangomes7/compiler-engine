...
public class DFAMinimizer {
    ...
    public DFA minimize(DFA dfa) {
        ...
        log.info(
                "Starting DFA minimization for token '{}'. Initial states: {}",
                dfa.getTokenName(),
                n);
        ...
        log.debug(
                "Partitioned initial states into {} block(s) based on acceptance tokens.",
                blockCount);
        ...
        log.info(
                "Minimization computed in {} ms. States reduced from {} to {}.",
                duration,
                n,
                numBlocks);
    ...
    public DFA trimUnreachableStates(DFA dfa) {
        ...
        if (newSize < originalSize) {
            log.info(
                    "Trimmed {} unreachable states. Final DFA size: {}",
