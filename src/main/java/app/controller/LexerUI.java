...
public class LexerUI {
    ...
    @FXML
    private TableView<Symbol> symbolTableViewer;

    @FXML
    private Label tokenFileLabel;

    @FXML
    private Label inputFileLabel;

    @FXML
    private Button loadTokenBtn;

    @FXML
    private Button loadInputBtn;

    @FXML
    private Button runLexerBtn;
